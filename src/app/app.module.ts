...
import { NbThemeModule, NbLayoutModule, NbSidebarModule, NbActionsModule,NbCardModule,NbInputModule,
   NbIconModule, NbTooltipModule, NbCalendarModule, NbMenuModule, NbTreeGridModule,NbSelectModule,
    NbContextMenuModule, NbDatepickerModule, NbButtonModule,NbCheckboxModule, NbAccordionModule, 
    NbListModule,NbWindowModule, NbDialogModule,NbStepperModule,NbToastrModule} from '@nebular/theme';
